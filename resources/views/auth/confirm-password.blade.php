...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'UniRoad') }} - Confirmar senha</title>
    ...
    <body class="landing-bg min-h-screen text-white antialiased">
        <div class="relative z-10 max-w-4xl mx-auto px-6 py-12">
            ...
            <main class="grid gap-8 lg:grid-cols-2 items-start">
                <div class="space-y-6">
                    <h1 class="text-3xl font-extrabold">Confirme sua senha</h1>
                    <p class="text-white/75">Área segura: confirme sua senha antes de continuar.</p>
                </div>
